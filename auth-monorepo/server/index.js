...
// Normalize allowed origins: split on commas, trim, strip trailing slashes.
// This avoids the common pitfall where one origin is stored with a trailing
// "/" in env vars and silently breaks CORS.
const allowedOrigins = (process.env.CLIENT_URL || 'https://auth-monorepo1-two.vercel.app')
  .split(',')
